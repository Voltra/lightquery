...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AbstractCssEngine", function() { return AbstractCssEngine; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SizzleCssEngine", function() { return SizzleCssEngine; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cssEngine", function() { return cssEngine; });
...
var AbstractCssEngine = /*#__PURE__*/function () {
  ...
  _createClass(AbstractCssEngine, [{
    ...
    value: function findAll(selector) {
      ...
      throw new _errors_UnimplementedError__WEBPACK_IMPORTED_MODULE_14__["default"]("Call to unimplemented AbstractCssEngine#findAll(selector, [context, [previousResults]])");
    }
    /**
    ...
    value: function matchesSelector(selector, element) {
      throw new _errors_UnimplementedError__WEBPACK_IMPORTED_MODULE_14__["default"]("Call to unimplemented AbstractCssEngine#matchesSelector(selector, element)");
    }
    /**
    ...
    value: function filterMatches(selector, elements) {
      throw new _errors_UnimplementedError__WEBPACK_IMPORTED_MODULE_14__["default"]("Call to unimplemented AbstractCssEngine#filterMatches(selector, elements)");
    }
  }]);
...
var SizzleCssEngine = /*#__PURE__*/function (_AbstractCssEngine) {
  ...
  _createClass(SizzleCssEngine, [{
    ...
    key: "filterMatches",
    value: function filterMatches(selector, elements) {
      return sizzle__WEBPACK_IMPORTED_MODULE_13___default.a.matches(selector, _utils_helpers__WEBPACK_IMPORTED_MODULE_15__["default"].arrayLike.toArray(elements));
    }
  }]);
...
var notEnoughFor = function notEnoughFor(str) {
  return function () {
    return function (e) {
      throw e;
    }(new _errors_NotEnoughElementsError__WEBPACK_IMPORTED_MODULE_33__["default"]("Not enough elements to apply LightqueryCollection".concat(str, ")")));
  };
};
/**
...
var LightqueryCollectionImplDetails = /*#__PURE__*/function () {
  ...
  _createClass(LightqueryCollectionImplDetails, [{
    ...
    value: function getSetMethod(_ref) {
      ...
      var keys = _utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].spacedListString.toArray(key);
      var self = this.self;
    ...
    value: function classManip(_ref5) {
      ...
      if (typeof classNames === "string") {
        _utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].spacedListString.toArray(classNames).forEach(function (clazz) {
        ...
        return function (e) {
          throw e;
        }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected argument classNames to be a string in LightqueryCollection".concat(nameForStrict)));
      });
    ...
    value: function eventShorthand(_ref6) {
      ...
      if (typeof listener === "undefined") return self.trigger(eventName);else if (typeof listener === "function") return self.on(eventName, listener);else this.ifStrict(function () {
        return function (e) {
          throw e;
        }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected argument listener to be undefined or a function in LightqueryCollection".concat(nameForStrict)));
      });
      return self;
    }
    /**
    ...
    value: function getElement(domEl) {
      return _utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].elements.getElement(domEl);
    }
    /**
      ...
      switch (_typeof(selector)) {
        ...
        case "string":
          return this.$(ret.filter(function (el) {
            return _CssEngine__WEBPACK_IMPORTED_MODULE_27__["cssEngine"].matchesSelector(selector, el);
          }));
        ...
        default:
          this.ifStrict(function () {
            return function (e) {
              throw e;
            }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected selector to be a string or undefined in LightqueryCollection#children(selector)"));
          });
        ...
        switch (_typeof(value)) {
          ...
          default:
            this.ifStrict(function () {
              return function (e) {
                throw e;
              }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected value to be a string or a number in LightqueryCollection".concat(nameForStrict)));
            });
            break;
        }
...
var LightqueryCollection = /*#__PURE__*/function () {
  ...
  function LightqueryCollection(selector) {
    ...
    var previousResultSet = _toConsumableArray(previousResults);

    var initStrategy = _strategies_init__WEBPACK_IMPORTED_MODULE_30__["strategies"].find(function (strategy) {
    ...
    if (initStrategy) this.__.elements = initStrategy.process(selector, context, previousResultSet);else {
      this.__.ifStrict(function () {
        return function (e) {
          throw e;
        }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Invalid selector \"".concat(selector, "\"")));
      });
  ...
  _createClass(LightqueryCollection, [{
    ...
    value: function ready(callback) {
      if (this.__.selector === document) {
        ...
        } else throw new _errors_UnsupportedError__WEBPACK_IMPORTED_MODULE_28__["default"]("Cannot attach document ready event handler");
      }
    ...
    value: function resize(listener) {
      if (this.__.selector !== window) {
        this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Can only attach resize events on the window object"));
        });
    ...
    value: function toArray() {
      return _utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].arrayLike.toArray(this.__.elements);
    }
    /****************************************************************************************\
     * Single item methods
    \****************************************************************************************/
    ...
    value: function matches(selector) {
      return this.__.doOnFirst({
        ...
        onFirst: function onFirst(first) {
          return _CssEngine__WEBPACK_IMPORTED_MODULE_27__["cssEngine"].matchesSelector(selector, first);
        },
        defaultValue: false
      });
    }
    ...
    value: function on(eventNames, listener) {
      ...
      if (typeof listener === "function") {
        if (typeof eventNames === "string") {
          var events = _utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].spacedListString.toArray(eventNames);
          this.forEach(function (el) {
            events.forEach(function (event) {
              if (el.addEventListener) el.addEventListener(event, listener);else _this5.__.ifStrict(function () {
                return function (e) {
                  throw e;
                }(new _errors_UnsupportedError__WEBPACK_IMPORTED_MODULE_28__["default"]("Cannot attach event listeners"));
              });
            });
          });
          ...
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected eventNames to be a string in LightqueryCollection#on(eventNames, listener)"));
        });
      } else this.__.ifStrict(function () {
        return function (e) {
          throw e;
        }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Invalid listener in LightqueryCollection#on(eventNames, listener)"));
      });
    ...
    value: function off(eventNames, listener) {
      ...
      if (typeof listener === "function") {
        if (typeof eventNames === "string") {
          ...
          this.forEach(function (el) {
            events.forEach(function (event) {
              if (e.removeEventListener) e.removeEventListener(event, listener);else _this6.__.ifStrict(function () {
                return function (e) {
                  throw e;
                }(new _errors_UnsupportedError__WEBPACK_IMPORTED_MODULE_28__["default"]("Cannot detach event listeners"));
              });
            });
          });
        } else this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected eventNames to be a string in LightqueryCollection#off(eventNames, listener)"));
        });
      } else this.__.ifStrict(function () {
        return function (e) {
          throw e;
        }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Invalid listener in LightqueryCollection#off(eventNames, listener)"));
      });
    ...
    value: function trigger(eventNames) {
      ...
      if (typeof eventNames !== "string") this.__.ifStrict(function () {
        return function (e) {
          throw e;
        }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected eventNames to be a string in LightqueryCollection#trigger(eventNames, options)"));
      });
      if (_typeof(options) !== "object" || options === null) this.__.ifStrict(function () {
        return function (e) {
          throw e;
        }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected options to be an object in LightqueryCollection#trigger(eventNames, options)"));
      });
      var events = _utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].spacedListString.toArray(eventNames);
    ...
    value: function closest(selector) {
      if (typeof selector !== "string") {
        this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected selector to be a string in LightqueryCollection#closest(selector)"));
        });
    ...
    value: function children() {
      ...
      var ret = this.reduce(function (children, el) {
        if (el.children.length > 0) children.push(_utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].arrayLike.toArray(el.children));
        return children;
      }, []);
    ...
    value: function has(selector) {
      ...
      if (typeof selector !== "string") {
        this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected selector to be a string in LightqueryCollection#has(selector)"));
        });
    ...
    value: function append(elements) {
      ...
      return this.__.doOnFirst({
        onFirst: function onFirst(el) {
          _utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].elements.forElements({
            elements: elements,
    ...
    value: function appendTo(element) {
      ...
      try {
        _utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].elements.forElement({
          element: element,
          LightqueryCollection: LightqueryCollection,
      ...
      if (typeof value === "undefined") {
        if (properties instanceof Array) {
              ...
              return properties.reduce(function (ret, property) {
                if (typeof property !== "string") {
                  _this19.__.ifStrict(function () {
                    return function (e) {
                      throw e;
                    }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Property \"".concat(property, "\" is not a string")));
                  });
          ...
          this.__.ifStrict(function () {
            return function (e) {
              throw e;
            }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Invalid properties in LightqueryCollection#css(properties, value)"));
          });
          ...
          return props.forEach(function (prop) {
            if (typeof prop !== "string") {
              _this19.__.ifStrict(function () {
                return function (e) {
                  throw e;
                }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Property \"".concat(prop, "\" is not a string")));
              });
    ...
    value: function cssVar(variable, value) {
      if (typeof variable !== "string") {
        this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_29__["default"]("Expected variable to be a string in LightqueryCollection#cssVar(variable, value)"));
        });

        return typeof value === "undefined" ? null : this;
      }

      var varname = _utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].css_variables.regex.no_trailing.test(variable) ? "--".concat(variable) : variable;
    ...
    value: function borderBoxWidth() {
      ...
      return this.__.doOnFirst({
        ...
        onFirst: function onFirst(el) {
          ...
          var _map = [borderLeftWidth, borderRightWidth].map(_utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].string.parsePx),
    ...
    value: function borderBoxHeight() {
      ...
      return this.__.doOnFirst({
        ...
        onFirst: function onFirst(el) {
          ...
          var _map3 = [borderTopWidth, borderBottomWidth].map(_utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].string.parsePx),
    ...
    value: function marginBoxWidth() {
      ...
      return this.__.doOnFirst({
        ...
        onFirst: function onFirst(el) {
          ...
          var _map5 = [marginLeft, marginRight].map(_utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].string.parsePx),
    ...
    value: function marginBoxHeight() {
      ...
      return this.__.doOnFirst({
        ...
        onFirst: function onFirst(el) {
          ...
          var _map7 = [marginTop, marginBottom].map(_utils_helpers__WEBPACK_IMPORTED_MODULE_31__["default"].string.parsePx),
...
/* harmony default export */ __webpack_exports__["default"] = (LightqueryCollection);
...
var LightqueryFactoryImplDetails = /*#__PURE__*/function () {
  ...
  function LightqueryFactoryImplDetails(self) {
    var collectionClass = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _LightqueryCollection__WEBPACK_IMPORTED_MODULE_19__["default"];
...
var LightqueryFactory = /*#__PURE__*/function (_Callable) {
  ...
  function LightqueryFactory() {
    ...
    var collectionClass = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _LightqueryCollection__WEBPACK_IMPORTED_MODULE_19__["default"];
    ...
    value: function hasPlugin(pluginName) {
      ...
      if (typeof pluginName !== "string") {
        this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_20__["default"]("Expected pluginName to be a string in LightqueryFactory".concat(nameForStrict)));
        });
      ...
      if (typeof pluginType !== "string") {
        this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_20__["default"]("Expected pluginType to be a string in LightqueryFactory".concat(nameForStrict)));
        });

        return false;
      }

      if (!_utils_helpers__WEBPACK_IMPORTED_MODULE_21__["default"].plugin.isValidPluginType(pluginType)) {
        this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_20__["default"]("Invalid plugin type \"".concat(pluginType, "\" in LightqueryFactory").concat(nameForStrict)));
        });
    ...
    value: function registerPlugin(pluginName, plugin) {
      ...
      */
      ...
      if (hasPlugin) {
        ...
        var pname = _utils_helpers__WEBPACK_IMPORTED_MODULE_21__["default"].string.capitalizeFirst(pluginType);

        this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_20__["default"]("".concat(pname, " plugin \"").concat(pluginName, "\" already registered")));
        });
      } else {
        _utils_helpers__WEBPACK_IMPORTED_MODULE_21__["default"].plugin.doForPluginType({
          ...
          onUnknown: function onUnknown() {
            _this2.__.ifStrict(function () {
              return function (e) {
                throw e;
              }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_20__["default"]("Invalid pluginType in LightqueryFactory#registerPlugin(pluginName, plugin, pluginType)"));
            });
          }
        });
    ...
    value: function removePlugin(pluginName) {
      ...
      if (hasPlugin) {
        _utils_helpers__WEBPACK_IMPORTED_MODULE_21__["default"].plugin.doForPluginType({
          ...
          onUnknown: function onUnknown() {
            _this3.__.ifStrict(function () {
              return function (e) {
                throw e;
              }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_20__["default"]("Invalid pluginType in LightqueryFactory#removePlugin(pluginName, pluginType)"));
            });
          }
        });
        ...
        this.__.ifStrict(function () {
          return function (e) {
            throw e;
          }(new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_20__["default"]("".concat(pname, " plugin \"").concat(pluginName, "\" is not registered")));
        });
      }
...
}(_utils_Callable__WEBPACK_IMPORTED_MODULE_18__["default"]);

/* harmony default export */ __webpack_exports__["default"] = (LightqueryFactory);
...
/* harmony default export */ __webpack_exports__["default"] = (InvalidArgumentError);
...
/* harmony default export */ __webpack_exports__["default"] = (NotEnoughElementsError);
...
/* harmony default export */ __webpack_exports__["default"] = (UnimplementedError);
...
/* harmony default export */ __webpack_exports__["default"] = (UnsupportedError);
...
var makePureLightquery = function makePureLightquery() {
  ...
  return new _LightqueryFactory__WEBPACK_IMPORTED_MODULE_2__["default"](_LightqueryCollection__WEBPACK_IMPORTED_MODULE_3__["default"], strict);
};
/**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AbstractStrategy; });
...
var AbstractStrategy = /*#__PURE__*/function () {
  ...
  _createClass(AbstractStrategy, [{
    ...
    value: function shouldProcess(selector) {
      var context = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
      var previousResults = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
      throw new _errors_UnimplementedError__WEBPACK_IMPORTED_MODULE_1__["default"]("Call to unimplemented AbstractStrategy#shouldProcess(selector)");
    }
    /**
    ...
    value: function process(selector) {
      var context = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
      var previousResults = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
      throw new _errors_UnimplementedError__WEBPACK_IMPORTED_MODULE_1__["default"]("Call to unimplemented AbstractStrategy#process(selector)");
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CssSelectorStrategy; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
var CssSelectorStrategy = /*#__PURE__*/function (_AbstractStrategy) {
  ...
  _createClass(CssSelectorStrategy, [{
    ...
    value: function process(selector) {
      var context = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
      var previousResults = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
      return _CssEngine__WEBPACK_IMPORTED_MODULE_15__["cssEngine"].findAll(selector, context, previousResults);
    }
  }]);

  return CssSelectorStrategy;
}(_AbstractStrategy__WEBPACK_IMPORTED_MODULE_14__["default"]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return IterableStrategy; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
}(_AbstractStrategy__WEBPACK_IMPORTED_MODULE_20__["default"]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LightqueryCollectionStrategy; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
var LightqueryCollectionStrategy = /*#__PURE__*/function (_AbstractStrategy) {
  ...
  _createClass(LightqueryCollectionStrategy, [{
    ...
    value: function shouldProcess(selector) {
      var context = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
      var previousResults = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
      return selector instanceof _LightqueryCollection__WEBPACK_IMPORTED_MODULE_15__["default"];
    }
  }, {
    key: "process",
    value: function process(selector) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SingleElementStrategy; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
var strategies = [new _LightqueryCollectionStrategy__WEBPACK_IMPORTED_MODULE_3__["default"](), new _CssSelectorStrategy__WEBPACK_IMPORTED_MODULE_0__["default"](), new _SingleElementStrategy__WEBPACK_IMPORTED_MODULE_1__["default"](), new _IterableStrategy__WEBPACK_IMPORTED_MODULE_2__["default"]()];
...
var Callable = /*#__PURE__*/function (_Function) {
  ...
  _createClass(Callable, [{
    ...
    value: function __call() {
      throw new _errors_UnimplementedError__WEBPACK_IMPORTED_MODULE_17__["default"]("Unimplemented Callable#__call(...args)");
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (Callable);
  ...
  elements: {
        ...
        if (elements.forEach) {
          elements.forEach(function (e) {
            if (!_this.isElement(e)) {
              throw new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_22__["default"]("Expected elements to contain (only) elements in LightqueryCollection".concat(nameForStrict));
            } else {
              onElement(_this.getElement(e));
            }
          });
        } else {
          throw new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_22__["default"]("Expected elements to be iterable or an element in LightqueryCollection".concat(nameForStrict));
        }
      }
    },
    ...
    forElement: function forElement(_ref3) {
      ...
      if (element instanceof LightqueryCollection) {
        ...
        throw new _errors_InvalidArgumentError__WEBPACK_IMPORTED_MODULE_22__["default"]("Expected element to be an Element, a LightqueryCollection or a CSS selector in LightqueryCollection".concat(nameForStrict));
      }
    }
  }
};
